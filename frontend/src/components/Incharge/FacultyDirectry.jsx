...
const FacultyDirectry = () => {
  ...
  return (
    <div className="flex-1 w-full flex flex-col h-full overflow-hidden bg-slate-50 dark:bg-[#020617] transition-colors duration-500">
      ...
      <div className="w-full px-4 md:px-8 pt-6 pb-2 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-semibold rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-emerald-600/20 active:scale-[0.98]"
        >
          <Plus size={16} />
